...
`nexus_net` is enabled by default through `NEXUS_ENABLE_NET=ON` and uses cpp-httplib and standalone Asio as private backends for HTTP, TCP, and UDP utilities.
