...
- Current Phase 4: `nexus_net` provides networking components. It currently includes HTTP, synchronous TCP, and synchronous UDP utilities and will expand to WebSocket.
